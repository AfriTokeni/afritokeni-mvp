...
<svelte:head>
	...
	<meta name="description" content="The first SMS-accessible DAO bringing democratic governance to 14.6 million unbanked Africans" />
</svelte:head>
	...
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<div class="text-center">
			<div class="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-3 py-1.5 sm:px-4 sm:py-2 rounded-full mb-4 sm:mb-6">
				<Vote class="w-4 h-4 sm:w-5 sm:h-5" />
			...
			<p class="text-lg sm:text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto px-4 sm:px-0">
...
<div class="py-12 sm:py-16 lg:py-20 bg-white">
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<div class="text-center mb-12 sm:mb-16">
			<h2 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">What is a DAO?</h2>
...
<div class="py-12 sm:py-16 lg:py-20 bg-gray-50">
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<div class="text-center mb-12 sm:mb-16">
			<div class="inline-flex items-center gap-2 bg-blue-100 text-blue-700 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full mb-3 sm:mb-4">
				<Coins class="w-4 h-4 sm:w-5 sm:h-5" />
				<span class="text-sm sm:text-base">Governance Token</span>
			</div>
			<h2 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">Token Allocation</h2>
			<p class="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto px-4 sm:px-0">
				1 Billion AFRI tokens distributed to align incentives across the ecosystem
			</p>
		</div>

		<div class="grid lg:grid-cols-2 gap-6 lg:gap-8 mb-8 sm:mb-12">
			<!-- Token Distribution -->
			<div class="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-gray-200">
				<h3 class="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Token Distribution</h3>
				<div class="space-y-4">
					<div>
						...
						<p class="text-sm text-gray-500 mt-1">Agents: 250M | Users: 150M</p>
					</div>
					...
					<div>
						...
						<div class="w-full bg-gray-200 rounded-full h-3">
							<div class="bg-gradient-to-r from-cyan-500 to-teal-500 h-3 rounded-full" style="width: 30%"></div>
						</div>
						<p class="text-sm text-gray-500 mt-1">DAO-controlled for ecosystem growth</p>
					</div>
					...
					<div>
						...
						<div class="w-full bg-gray-200 rounded-full h-3">
							<div class="bg-gradient-to-r from-teal-500 to-green-500 h-3 rounded-full" style="width: 20%"></div>
						</div>
						<p class="text-sm text-gray-500 mt-1">Seed: 50M | Private: 100M | Public: 50M</p>
					</div>
					...
					<div>
						...
						<div class="w-full bg-gray-200 rounded-full h-3">
							<div class="bg-gradient-to-r from-green-500 to-emerald-500 h-3 rounded-full" style="width: 10%"></div>
						</div>
						<p class="text-sm text-gray-500 mt-1">4-year vesting with 1-year cliff</p>
					</div>
				</div>
			</div>
...
<div class="py-12 sm:py-16 lg:py-20 bg-white">
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<div class="text-center mb-12 sm:mb-16">
			<div class="inline-flex items-center gap-2 bg-green-100 text-green-700 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full mb-3 sm:mb-4">
				<TrendingUp class="w-4 h-4 sm:w-5 sm:h-5" />
				<span class="text-sm sm:text-base">Earn Rewards</span>
			</div>
			<h2 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">How to Earn AFRI</h2>
			<p class="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto px-4 sm:px-0">
				...
				<div class="space-y-3 sm:space-y-4">
					...
					<div class="border-t border-green-200 pt-4 mt-4">
						<div class="bg-white rounded-xl p-4">
							<p class="text-sm text-gray-600 mb-2">Example Monthly Earnings (Rural):</p>
							<p class="text-gray-900">
								<span class="font-semibold">20 deposits + 15 withdrawals + 5 BTC exchanges</span>
							</p>
							<p class="text-2xl font-bold text-green-600 mt-2">4,500 AFRI/month</p>
						</div>
					</div>
				</div>
			</div>
...
<div class="py-12 sm:py-16 lg:py-20 bg-gray-50">
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<div class="text-center mb-12 sm:mb-16">
			<h2 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">How Governance Works</h2>
			<p class="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto px-4 sm:px-0">
		...
		<div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
			<div class="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-200 text-center">
				<div class="w-12 h-12 sm:w-16 sm:h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
					<span class="text-lg sm:text-2xl font-bold text-blue-600">1</span>
				</div>
				<h3 class="text-base sm:text-lg font-bold text-gray-900 mb-2">Proposal</h3>
				<p class="text-xs sm:text-sm text-gray-600">Community members submit proposals</p>
			</div>

			<div class="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-200 text-center">
				<div class="w-12 h-12 sm:w-16 sm:h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
					<span class="text-lg sm:text-2xl font-bold text-green-600">2</span>
				</div>
				<h3 class="text-base sm:text-lg font-bold text-gray-900 mb-2">Discussion</h3>
				<p class="text-xs sm:text-sm text-gray-600">48-hour community discussion period</p>
			</div>

			<div class="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-200 text-center">
				<div class="w-12 h-12 sm:w-16 sm:h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
					<span class="text-lg sm:text-2xl font-bold text-purple-600">3</span>
				</div>
				<h3 class="text-base sm:text-lg font-bold text-gray-900 mb-2">Voting</h3>
				<p class="text-xs sm:text-sm text-gray-600">7-day voting period via web or SMS</p>
			</div>

			<div class="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-200 text-center">
				<div class="w-12 h-12 sm:w-16 sm:h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
					<span class="text-lg sm:text-2xl font-bold text-orange-600">4</span>
				</div>
				<h3 class="text-base sm:text-lg font-bold text-gray-900 mb-2">Execution</h3>
				<p class="text-xs sm:text-sm text-gray-600">Approved proposals automatically execute</p>
			</div>
		</div>

		<div class="mt-8 sm:mt-12 bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-gray-200">
...
<div class="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-blue-600 to-cyan-600 text-white">
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<div class="text-center mb-8 sm:mb-12">
			...
			<p class="text-lg sm:text-xl text-blue-100 max-w-3xl mx-auto px-4 sm:px-0">
				No internet required - participate in governance from any phone
			</p>
		</div>

		<div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 sm:p-8 max-w-2xl mx-auto border border-white/20">
			<div class="bg-gray-900 rounded-xl p-4 sm:p-6 font-mono text-sm sm:text-base">
				<div class="text-green-400 mb-2">SMS Commands:</div>
			...
			<div class="mt-4 sm:mt-6 flex items-center justify-center gap-4 text-sm sm:text-base text-blue-100">
...
<div class="py-12 sm:py-16 lg:py-20 bg-white">
	<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
		...
		<p class="text-lg sm:text-xl text-gray-600 mb-6 sm:mb-8 px-4 sm:px-0">
			Start earning AFRI tokens and participate in platform governance
		</p>
		<div class="flex flex-col sm:flex-row gap-4 justify-center">
			<a
				href="/auth/register"
				class="inline-flex items-center justify-center gap-2 bg-blue-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold hover:bg-blue-700 transition-colors text-sm sm:text-base"
			>
				Start Earning AFRI
			...
			<a
				href="/become-agent"
				class="inline-flex items-center justify-center gap-2 bg-gray-100 text-gray-700 px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold hover:bg-gray-200 transition-colors text-sm sm:text-base"
			>
				Become an Agent
			</a>
		</div>
