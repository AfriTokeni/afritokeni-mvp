 ...
 * Used for creating deterministic principals from phone numbers and identifiers.
 */
 ...
 * - Same phone number always generates same principal
 * - Used for USSD users without Internet Identity
 * - Enables phone-based ckBTC/ckUSD transfers
 * - Principal is derived, NOT stored on ICP
 * 
