	...
	<div class="bg-gradient-to-r from-purple-600 to-purple-700 text-white py-2 px-4">
		<div class="max-w-7xl mx-auto flex items-center justify-between gap-4">
			<div class="flex items-center gap-2 md:gap-3 min-w-0 flex-1">
				<Zap class="w-4 h-4 md:w-5 md:h-5 flex-shrink-0" />
				<div class="min-w-0">
			...
			<button
				...
				class="flex items-center gap-1 md:gap-2 px-2 md:px-3 py-1 bg-white/20 hover:bg-white/30 rounded-lg transition-colors text-xs md:text-sm font-medium whitespace-nowrap flex-shrink-0"
			>
