      ...
      <PageLayout>
        <div className="flex items-center justify-center min-h-96">
          <div className="text-center">
            ...
            <p className="text-neutral-600">Loading exchange data...</p>
          </div>
        </div>
      </PageLayout>
    );
    ...
    <PageLayout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-neutral-900">Bitcoin Exchange</h1>
            <p className="text-neutral-600 mt-1">Manage customer Bitcoin exchanges</p>
          </div>
        ...
        {activeTab === 'requests' && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-white border border-neutral-200 p-4 rounded-xl shadow-sm">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-neutral-600 text-sm">Processing</p>
                    <p className="text-xl font-bold text-neutral-900">
              ...
              <div className="bg-white border border-neutral-200 p-4 rounded-xl shadow-sm">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-neutral-600 text-sm">Completed Today</p>
                    <p className="text-xl font-bold text-neutral-900">
            ...
            {/* Exchange Requests */}
            <div className="space-y-4">
              <h2 className="text-lg font-bold text-neutral-900">Active Requests</h2>
              ...
              {exchangeRequests.filter(r => r.status !== 'completed' && r.status !== 'cancelled').length === 0 ? (
                ...
                exchangeRequests
                  ...
                  .map((request) => (
                    <div key={request.id} className="bg-white border border-neutral-200 p-6 rounded-xl shadow-sm">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center space-x-3 mb-3">
                            ...
                            <div>
                              ...
                              <p className="text-neutral-600 text-sm">{request.customerPhone}</p>
                            </div>
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                            ...
                            <div>
                              <p className="text-neutral-500">Bitcoin</p>
                              <p className="font-semibold text-neutral-900 font-mono">
                            ...
                            <div>
                              ...
                              <p className="font-semibold text-neutral-900 flex items-center">
            ...
            <div className="bg-white border border-neutral-200 p-6 rounded-xl shadow-sm">
              ...
              {calcAmount && (
                <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <div className="text-center">
                    <p className="text-neutral-600 text-sm mb-2">Converts to:</p>
        ...
        <div className="bg-neutral-50 border border-neutral-200 p-6 rounded-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <h4 className="font-semibold text-neutral-900 mb-2">Accept Exchange Request:</h4>
              <div className="bg-white p-3 rounded-lg border border-neutral-200">
                <code className="text-sm text-neutral-700">EXCHANGE ACCEPT [request-id]</code>
              </div>
            </div>

            <div>
              <h4 className="font-semibold text-neutral-900 mb-2">Complete Exchange:</h4>
              <div className="bg-white p-3 rounded-lg border border-neutral-200">
                <code className="text-sm text-neutral-700">EXCHANGE COMPLETE [request-id]</code>
              </div>
            </div>
            ...
            <div>
              <h4 className="font-semibold text-neutral-900 mb-2">List Pending Requests:</h4>
              <div className="bg-white p-3 rounded-lg border border-neutral-200">
                <code className="text-sm text-neutral-700">EXCHANGE LIST</code>
              </div>
            </div>
          </div>
