    ...
    <div className="max-w-2xl mx-auto">
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6 lg:p-8">
        <div className="text-center mb-6 md:mb-8">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">Deposit Request Created</h2>
          <p className="text-sm md:text-base text-gray-600">Meet your agent to complete the deposit</p>
        </div>
        ...
        <div className="space-y-4 md:space-y-6">
          ...
          <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4">
            <button
              ...
              className="flex-1 bg-gray-900 text-white py-2 md:py-3 px-3 md:px-4 rounded-lg font-medium text-sm md:text-base hover:bg-gray-800 transition-colors"
            >
              Return to Dashboard
            </button>
            <button
              onClick={onMakeAnother}
              className="flex-1 bg-white border border-gray-300 text-gray-700 py-2 md:py-3 px-3 md:px-4 rounded-lg font-medium text-sm md:text-base hover:bg-gray-50 transition-colors"
            >
