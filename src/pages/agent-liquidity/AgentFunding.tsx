        ...
        <div className="max-w-2xl mx-auto p-3 md:p-4">
          <div className="bg-white rounded-xl md:rounded-2xl shadow-sm border border-gray-200 p-4 md:p-6">
            <div className="text-center">
              ...
              <h2 className="text-lg md:text-2xl font-bold text-gray-900 mb-2">Funding Request Submitted</h2>
              ...
              <div className="bg-gray-50 rounded-lg p-3 md:p-4 mb-4 md:mb-6">
                <div className="text-left space-y-1.5 md:space-y-2">
                  <p className="text-xs md:text-sm"><strong>Reference:</strong> <span className="font-mono text-xs">{fundingReference}</span></p>
                  <p className="text-xs md:text-sm"><strong>Amount:</strong> UGX {parseFloat(amount).toLocaleString()}</p>
                  <p className="text-xs md:text-sm"><strong>Method:</strong> {fundingMethods.find(m => m.id === selectedMethod)?.name}</p>
                  <p className="text-xs md:text-sm"><strong>Status:</strong> 
              ...
              {selectedMethod === 'bank_transfer' && (
                <div className="bg-blue-50 rounded-lg p-3 md:p-4 mb-4 md:mb-6 text-left">
                  <h3 className="font-semibold text-blue-900 mb-2 text-xs md:text-sm">Next Steps:</h3>
                  <ol className="text-xs md:text-sm text-blue-800 space-y-1 list-decimal list-inside">
                    ...
                    <li>Use reference: <span className="font-mono text-xs">{fundingReference}</span></li>
              ...
              {selectedMethod === 'mobile_money' && (
                <div className="bg-green-50 rounded-lg p-3 md:p-4 mb-4 md:mb-6 text-left">
                  <h3 className="font-semibold text-green-900 mb-2 text-xs md:text-sm">Processing:</h3>
              ...
              {selectedMethod === 'cash_deposit' && (
                <div className="bg-orange-50 rounded-lg p-3 md:p-4 mb-4 md:mb-6 text-left">
                  <h3 className="font-semibold text-orange-900 mb-2 text-xs md:text-sm">Visit AfriTokeni Office:</h3>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <button
                  ...
                  className="flex-1 bg-gray-100 text-gray-700 py-2.5 md:py-3 rounded-lg font-semibold hover:bg-gray-200 transition-colors text-sm md:text-base"
                >
                  New Funding Request
                </button>
                <button
                  onClick={() => navigate('/agents/dashboard')}
                  className="flex-1 bg-gray-900 text-white py-2.5 md:py-3 rounded-lg font-semibold hover:bg-gray-800 transition-colors text-sm md:text-base"
                >
                  Back to Dashboard
                </button>
              </div>
    ...
    <div className="space-y-4 md:space-y-6">
      <div className="max-w-4xl mx-auto p-3 md:p-4 space-y-4 md:space-y-6">
        ...
        <div className="flex items-center space-x-3 md:space-x-4 mb-6 md:mb-8">
          ...
          <div>
            <h1 className="text-xl md:text-2xl font-bold text-gray-900">Fund Your Account</h1>
            <p className="text-gray-600 text-sm md:text-base">Add digital balance to process customer deposits</p>
          </div>
        </div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 md:p-4">
          <div className="flex items-center space-x-2 md:space-x-3">
            ...
            <div>
              <h3 className="font-semibold text-yellow-900 text-sm md:text-base">Current Digital Balance</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
          {/* Funding Form */}
          <div className="bg-white rounded-xl md:rounded-2xl shadow-sm border border-gray-200 p-4 md:p-6">
            <h2 className="text-lg md:text-xl font-bold text-gray-900 mb-4 md:mb-6">Add Funds</h2>
            ...
            {selectedMethod === 'bank_transfer' && (
              <div className="mb-4 md:mb-6 space-y-3 md:space-y-4">
                <h3 className="font-semibold text-gray-900 text-xs md:text-sm">Bank Transfer Details</h3>
                <div>
                  <label className="block text-xs md:text-sm font-medium text-gray-700 mb-1 md:mb-2">Your Bank Name</label>
                  <input
                    type="text"
          ...
          <div className="space-y-4 md:space-y-6">
            {/* How it Works */}
            <div className="bg-white rounded-xl md:rounded-2xl shadow-sm border border-gray-200 p-4 md:p-6">
              <h3 className="text-base md:text-lg font-bold text-gray-900 mb-3 md:mb-4">How Agent Funding Works</h3>
              <div className="space-y-3 md:space-y-4 text-xs md:text-sm text-gray-600">
                <div className="flex items-start space-x-2 md:space-x-3">
                  <div className="w-5 h-5 md:w-6 md:h-6 bg-gray-100 rounded-full flex items-center justify-center text-xs font-bold text-gray-600">1</div>
                  <p>You transfer money to AfriTokeni using your preferred method</p>
                </div>
                <div className="flex items-start space-x-2 md:space-x-3">
                  <div className="w-5 h-5 md:w-6 md:h-6 bg-gray-100 rounded-full flex items-center justify-center text-xs font-bold text-gray-600">2</div>
                  <p>Your digital balance increases, allowing you to process customer deposits</p>
                </div>
                <div className="flex items-start space-x-2 md:space-x-3">
                  <div className="w-5 h-5 md:w-6 md:h-6 bg-gray-100 rounded-full flex items-center justify-center text-xs font-bold text-gray-600">3</div>
                  <p>When customers deposit cash, your digital balance converts to commission earnings</p>
                </div>
                <div className="flex items-start space-x-2 md:space-x-3">
                  <div className="w-5 h-5 md:w-6 md:h-6 bg-gray-100 rounded-full flex items-center justify-center text-xs font-bold text-gray-600">4</div>
            ...
            <div className="bg-blue-50 rounded-lg p-3 md:p-4 border border-blue-200">
              <h4 className="font-semibold text-blue-900 mb-2 text-xs md:text-sm">Funding Guidelines</h4>
            ...
            <div className="bg-green-50 rounded-lg p-3 md:p-4 border border-green-200">
              <h4 className="font-semibold text-green-900 mb-2 text-xs md:text-sm">Security & Trust</h4>
              <p className="text-xs md:text-sm text-green-800">
