  ...
  return (
    <div className="space-y-4 md:space-y-6">
      <div className="text-center">
        <h2 className="text-xl md:text-2xl font-bold text-neutral-900 mb-2">How much Bitcoin?</h2>
        <p className="text-neutral-600 text-sm md:text-base">Enter the amount you want to exchange for cash</p>
      </div>
      ...
      <div className="bg-white border border-neutral-200 rounded-lg md:rounded-xl p-4 md:p-6 shadow-sm">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="0.001"
                className="w-full px-3 md:px-4 py-2.5 md:py-3 border border-neutral-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 font-mono text-base md:text-lg"
              />
              <div className="absolute right-3 top-2.5 md:top-3 text-neutral-500 font-medium text-sm md:text-base">
                ₿ BTC
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <select
                ...
                className="absolute right-3 top-2.5 md:top-3 bg-transparent border-none text-neutral-500 font-medium focus:outline-none text-sm md:text-base"
              >
        ...
        <button
          ...
          className="w-full mt-4 md:mt-6 bg-orange-600 text-white py-2.5 md:py-3 rounded-lg font-medium hover:bg-orange-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm md:text-base"
        >
          Find Agent
        </button>
      </div>
