  ...
  return L.divIcon({
    html: `
      <div class="relative" style="width: ${size}px; height: ${size}px;">
        ...
        <div class="relative flex items-center justify-center w-full h-full bg-blue-600 rounded-full text-white shadow-lg">
...
const createAgentIcon = (isActive: boolean) => {
  ...
  const bgColor = isActive ? '#10b981' : '#9ca3af'; // green-500 : gray-400
  
  return L.divIcon({
    html: `
      <div class="relative flex items-center justify-center rounded-full text-white border-2 border-white shadow-lg" 
...
const AgentMapPage: React.FC = () => {
  ...
  return (
    <div className="space-y-4 md:space-y-6">
        {/* Search and Filters */}
        <div className="bg-white rounded-xl md:rounded-2xl shadow-sm border border-gray-200 p-4 md:p-6 mb-6 md:mb-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-4 md:mb-6 space-y-3 md:space-y-0">
            <h2 className="text-base md:text-lg font-semibold text-gray-900">Search & Filter Agents</h2>
            {/* View Mode Toggle */}
            <div className="flex items-center bg-gray-100 rounded-lg p-1 self-start md:self-auto">
              <button
                onClick={() => setViewMode('list')}
                className={`flex items-center px-2 md:px-3 py-1.5 md:py-2 rounded-md text-xs md:text-sm font-medium transition-colors duration-200 ${
                  viewMode === 'list'
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
            ...
            <div className="relative md:col-span-2 lg:col-span-1">
              ...
              <input
                ...
                className="w-full pl-9 md:pl-10 pr-3 md:pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500 text-sm md:text-base"
              />
            </div>
            ...
            <div>
              <select
                ...
                className="w-full px-2 md:px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500 text-sm md:text-base"
              >
            ...
            <div className="flex items-center">
              <input
                ...
                className="h-3 w-3 md:h-4 md:w-4 text-gray-600 focus:ring-gray-500 border-gray-300 rounded"
              />
              <label htmlFor="onlineOnly" className="ml-1 md:ml-2 text-xs md:text-sm text-gray-700">
                Online agents only
              </label>
            </div>
        ...
        {viewMode === 'list' ? (
          ...
          {sortedAgents.map((agent) => (
            <div
              key={agent.id}
              className={`bg-white rounded-xl md:rounded-2xl shadow-sm border border-gray-200 p-4 md:p-6 hover:shadow-md transition-shadow duration-200 cursor-pointer ${
            ...
            >
              ...
              <div className="flex items-start justify-between mb-3 md:mb-4">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center text-xs md:text-sm text-gray-600 mb-1 md:mb-2">
                    ...
                    <span className="truncate">{agent.location.address}</span>
                  </div>
                  {userLocation && (
              ...
              <div className="grid grid-cols-2 gap-3 md:gap-4 mb-3 md:mb-4">
                <div>
                  ...
                  <p className="font-mono font-semibold text-xs md:text-sm text-gray-900">
              ...
              <div className="flex items-center mb-3 md:mb-4">
                ...
                <span className="ml-1 md:ml-2 text-xs md:text-sm text-gray-600">4.0 (23 reviews)</span>
              </div>
              ...
              <div className="flex flex-wrap gap-1 md:gap-2 mb-3 md:mb-4">
                ...
                <span className="px-1.5 md:px-2 py-0.5 md:py-1 bg-orange-100 text-orange-800 text-xs rounded-full">
                  Bitcoin Exchange
                </span>
              </div>
              ...
              <div className="flex gap-2">
                <button className="flex-1 bg-gray-900 text-white px-3 md:px-4 py-1.5 md:py-2 rounded-lg text-xs md:text-sm font-medium hover:bg-gray-800 transition-colors duration-200">
                  Contact Agent
                </button>
                <button className="px-3 md:px-4 py-1.5 md:py-2 border border-gray-300 text-gray-700 rounded-lg text-xs md:text-sm font-medium hover:bg-gray-50 transition-colors duration-200">
                ...
                <div className="mt-3 md:mt-4 pt-3 md:pt-4 border-t border-gray-200">
                  <div className="space-y-2 md:space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs md:text-sm text-gray-700">+256 700 123 456</p>
                      <p className="text-xs md:text-sm text-gray-700">agent@afritokeni.com</p>
                    </div>
                  </div>
                </div>
              )}
          ...
          /* Map View */
          <div className="bg-white rounded-xl md:rounded-2xl shadow-sm border border-gray-200 p-2 md:p-4 lg:p-6">
            <div className="w-full h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] rounded-lg overflow-hidden">
              ...
              >
                  ...
                  >
                    <Popup>
                      <div className="text-center">
                        <div className="font-semibold text-sm md:text-base text-blue-600">Your Location</div>
                ...
                {sortedAgents.map((agent) => (
                  ...
                  >
                    <Popup className="leaflet-popup-mobile">
                      <div className="min-w-32 max-w-48 sm:min-w-40 sm:max-w-56">
                        <div className="font-semibold text-sm md:text-base text-gray-900 mb-2 line-clamp-2">
                          {agent.businessName}
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-2 text-xs mb-2 md:mb-3">
                          <div>
                            <span className="text-gray-500">Cash:</span>
                            <div className="font-mono font-semibold text-xs truncate">{formatBalance(agent.cashBalance)} UGX</div>
                          </div>
                          <div>
                            <span className="text-gray-500">Fee:</span>
                            <div className="font-mono font-semibold text-xs">{agent.commissionRate > 0 ? agent.commissionRate : (agent.commissionRate * 100).toFixed(1)}%</div>
                          </div>
                        </div>
                        <button
                          onClick={() => setSelectedAgent(agent)}
                          className="w-full bg-gray-900 text-white px-2 md:px-3 py-1.5 md:py-2 rounded-lg text-xs md:text-sm font-medium hover:bg-gray-800 transition-colors duration-200"
                        >
                          Contact Agent
                        </button>
                      </div>
            ...
            {selectedAgent && viewMode === 'map' && (
              <div className="mt-4 md:mt-6 bg-gray-50 rounded-lg p-3 md:p-4">
                <h3 className="font-semibold text-sm md:text-base text-gray-900 mb-2">{selectedAgent.businessName}</h3>
                ...
                <div className="flex flex-col md:flex-row gap-2 mt-3 md:mt-4">
                  <button className="bg-gray-900 text-white px-3 md:px-4 py-1.5 md:py-2 rounded-lg text-xs md:text-sm font-medium hover:bg-gray-800 transition-colors duration-200">
                    Contact Agent
                  </button>
                  <button 
                    onClick={() => setSelectedAgent(null)}
                    className="px-3 md:px-4 py-1.5 md:py-2 border border-gray-300 text-gray-700 rounded-lg text-xs md:text-sm font-medium hover:bg-gray-50 transition-colors duration-200"
                  >
                    Close
                  </button>
                </div>
