      ...
      <div className="flex flex-col sm:flex-row gap-3 md:gap-4 mb-4 md:mb-6">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-8 md:pl-10 pr-3 md:pr-4 py-2 md:py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-colors duration-200 text-xs md:text-sm"
          />
        </div>
        ...
        <select
          ...
          className="px-3 md:px-4 py-2 md:py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-colors duration-200 text-xs md:text-sm"
        >
      ...
      <div className="space-y-3 md:space-y-4">
        {loading ? (
          <div className="text-center py-6 md:py-8 lg:py-12">
            <div className="w-10 h-10 md:w-12 md:h-12 lg:w-16 lg:h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-3 md:mb-4 animate-pulse">
              <CreditCard className="w-5 h-5 md:w-6 md:h-6 lg:w-8 lg:h-8 text-gray-400" />
            </div>
            <h3 className="text-sm md:text-base lg:text-lg font-semibold text-gray-900 mb-2">Loading withdrawal requests...</h3>
            <p className="text-gray-600 text-xs md:text-sm lg:text-base">Please wait while we fetch the latest requests</p>
          </div>
          ...
          <div className="text-center py-6 md:py-8 lg:py-12">
            ...
            <h3 className="text-sm md:text-base lg:text-lg font-semibold text-gray-900 mb-2">No withdrawal requests found</h3>
          ...
          filteredRequests.map((request) => (
            <div
              ...
              className="bg-white border border-gray-200 rounded-xl md:rounded-2xl p-3 md:p-4 lg:p-6 hover:shadow-md transition-all duration-200 cursor-pointer hover:border-gray-300"
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-3 sm:space-y-0">
                <div className="flex items-center space-x-3 md:space-x-4 min-w-0 flex-1">
                  {/* User Avatar */}
                  <div className="w-8 h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 bg-gray-100 rounded-full flex items-center justify-center flex-shrink-0">
                    <User className="w-4 h-4 md:w-5 md:h-5 lg:w-6 lg:h-6 text-gray-600" />
                  </div>
                  
                  {/* User Info */}
                  <div className="flex-1 min-w-0">
                    <h3 className="text-xs md:text-sm font-semibold text-gray-900 truncate">{request.userName}</h3>
                ...
                <div className="text-left sm:text-right flex-shrink-0">
                  <div className="text-sm md:text-base font-bold text-gray-900 font-mono">
                  ...
                  {/* Status Badge */}
                  <span className={`inline-flex items-center px-2 md:px-2.5 py-0.5 rounded-full text-xs font-semibold border ${getStatusColor(request.status)}`}>
