...
const SendMoney: React.FC = () => {
  ...
  const getAmountValidationClass = (amount: string): string => {
    if (!amount) return 'border-gray-300';
        ...
        {sendStep === 0 && (
          ...
          {sendStep === 1 && sendType === 'user' && (
            <div className="space-y-4 md:space-y-6">
                ...
                <div className="mb-4 sm:mb-6">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="10,000"
                      className={`w-full pl-9 sm:pl-10 pr-4 py-2.5 sm:py-3 text-sm sm:text-base border ${getAmountValidationClass(localAmount)} rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all duration-200`}
                    />
                  </div>
              ...
              <button
                ...
                className="w-full bg-gray-900 text-white py-2.5 sm:py-3 px-4 rounded-lg font-medium hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-sm sm:text-base"
              >
                Continue
              </button>
            </div>
          ...
          {sendStep === 2 && sendType === 'international' && (
            <div className="space-y-6">
              <div className="text-center">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">How much are you sending?</h2>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-600">Bitcoin Rate:</span>
                    <span className="font-mono">1 BTC = ${btcToUsd.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">{internationalRecipient.currency} Rate:</span>
          ...
          {sendStep === 2 && sendType === 'user' && (
            <div className="space-y-4 sm:space-y-6">
              <div className="bg-gray-50 p-4 sm:p-6 rounded-xl border border-gray-200">
                <h3 className="font-semibold mb-3 sm:mb-4 text-gray-900 text-base sm:text-lg">Transaction Summary</h3>
                <div className="space-y-3 sm:space-y-4">
                  {/* Recipient Row */}
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-1 sm:gap-2">
                    <span className="text-gray-600 text-sm sm:text-base flex-shrink-0">Recipient:</span>
                    <div className="font-medium text-gray-900 text-right sm:text-right">
                      {recipient ? (
                        <div>
                          <div className="text-sm sm:text-base break-words">{recipient.firstName} {recipient.lastName}</div>
                          <div className="text-xs sm:text-sm text-gray-500 break-all">{recipientPhone}</div>
                        </div>
                      ) : (
                  ...
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-2">
                    <span className="text-gray-600 text-sm sm:text-base flex-shrink-0">Amount:</span>
                    <div className="font-medium text-gray-900 font-mono text-sm sm:text-base text-right break-words">
                      {localAmount && (
                  ...
                  {/* Fee Row */}
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-2">
                    <span className="text-gray-600 text-sm sm:text-base flex-shrink-0">Fee (1%):</span>
                  ...
                  <div className="border-t border-gray-200 pt-3">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-2">
                      <span className="text-gray-900 font-semibold text-sm sm:text-base flex-shrink-0">Total:</span>
                      <span className="text-gray-900 font-mono font-semibold text-sm sm:text-base break-words">
              ...
              <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                <button
                  ...
                  className="flex-1 bg-gray-100 text-gray-700 py-2.5 sm:py-3 rounded-lg text-sm sm:text-base font-semibold hover:bg-gray-200 transition-colors duration-200 disabled:opacity-50"
                >
                  Back
                </button>
                <button
                  ...
                  disabled={isProcessing}
                  className="flex-1 bg-gray-900 text-white py-2.5 sm:py-3 rounded-lg text-sm sm:text-base font-semibold hover:bg-gray-800 transition-colors duration-200 disabled:opacity-50 flex items-center justify-center"
                >
                  {isProcessing ? (
                    <>
          ...
          {sendStep === 3 && sendType === 'international' && (
            <div className="space-y-6">
              <div className="text-center">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Review Your Transfer</h2>
                <p className="text-gray-600">Please confirm the details before sending</p>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-6 space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-sm text-gray-500">{internationalRecipient.phone}</div>
                  </div>
                </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-sm text-gray-500">${usdAmount}</div>
                  </div>
                </div>
          ...
          {sendStep === 3 && sendType === 'user' && transactionResult && (
            <div className="text-center py-8 sm:py-12">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">Money Sent Successfully!</h3>
              <p className="text-gray-600 mb-4 sm:mb-6 font-mono text-sm sm:text-base px-2 sm:px-4 break-words">
              ...
              <div className="bg-gray-50 px-3 sm:px-4 py-3 sm:py-4 rounded-lg mx-auto max-w-xs sm:max-w-sm">
                <div className="space-y-1 sm:space-y-2 text-xs sm:text-sm text-gray-600">
                  ...
                  <div className="flex justify-between items-center font-semibold text-gray-900 pt-1 border-t border-gray-200">
                    <span>Total:</span>
              ...
              <div className="mt-4 sm:mt-6">
                <button
                  ...
                  className="bg-gray-900 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg text-sm sm:text-base font-semibold hover:bg-gray-800 transition-colors duration-200"
                >
                  Send Another
                </button>
              </div>
          ...
          {sendStep === 4 && sendType === 'international' && transactionResult && (
            <div className="text-center py-8 sm:py-12">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">International Transfer Created!</h3>
              <p className="text-gray-600 mb-4 sm:mb-6 font-mono text-sm sm:text-base px-2 sm:px-4 break-words">
